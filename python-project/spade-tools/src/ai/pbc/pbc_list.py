        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                error_screenshot = os.path.join(
                    save_dir, f"error_screenshot_{page_num}.png"
                )
                try:
...
async def main():
    base_url = (
        "http://shanghai.pbc.gov.cn/fzhshanghai/113577/114832/114909/14678/index{}.html"
    )
    ...
    for page_num in range(1, 51):
        ...
        try:
            ...
            if result["status"] == "success":
                ...
                logger.error(
                    f"第 {page_num} 页爬取失败: {result.get('error', '未知错误')}"
                )
